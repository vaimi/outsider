...
void AOutsiderCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AOutsiderCharacter::TouchStarted);
	if (EnableTouchscreenMovement(PlayerInputComponent) == false)
	{
		PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AOutsiderCharacter::OnFire);
	}
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AOutsiderProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AOutsiderProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AOutsiderCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AOutsiderCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool AOutsiderCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AOutsiderCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AOutsiderCharacter::EndTouch);
